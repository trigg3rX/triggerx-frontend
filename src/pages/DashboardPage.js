            ...
            <div className="bg-[#141414] backdrop-blur-xl rounded-2xl p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {loading && connected ? (
                      ...
                      <div key={job.id} className="bg-[#1A1A1A] rounded-xl p-6 border border-[#2A2A2A] hover:border-[#3A3A3A] transition-all duration-300">
                        ...
                        {job.linkedJobs && job.linkedJobs.length > 0 && (
                          <button
                            ...
                            className="mt-4 flex items-center justify-between w-full p-2 bg-[#242323] rounded-xl border border-[#2A2A2A] hover:border-[#3A3A3A] transition-colors text-sm"
                          >
                            <span className="text-white text-md font-semibold">Linked Jobs</span>
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="20"
                              height="20"
                  ...
                  <div className="col-span-full text-center py-8">
                    <p className="text-[#A2A2A2]">No jobs found</p>
                  </div>
                )}
              </div>
              ...
              {getPaginatedData(getFilteredJobs()).map((job) => (
                job.linkedJobs && job.linkedJobs.length > 0 && expandedJobs[job.id] && (
                  <div key={`linked-${job.id}`} className="mt-8">
                    <h3 className="text-xl font-semibold text-white mb-4">Linked Jobs</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div key={linkedJob.job_id} className="bg-[#242323] rounded-xl p-6 border border-[#2A2A2A] hover:border-[#3A3A3A] transition-all duration-300">
                          ...
                          {expandedLinkedJobDetails[linkedJob.job_id] && (
                            <div className="mt-4 space-y-2 text-[#A2A2A2] text-sm">
                              ...
                              <p><span className="font-semibold text-white">Target Contract:</span> <span className="font-mono truncate">{linkedJob.target_contract_address || 'Not specified'}</span></p>
                              <p><span className="font-semibold text-white">Target Function:</span> <span className="font-mono truncate">{linkedJob.target_function || 'Not specified'}</span></p>
                            </div>
                          )}
                        </div>
                      ))}
