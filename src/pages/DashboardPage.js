                                                ...
                                                (linkedJob, index) => (
                                                  <tr key={index} className="hover:bg-[#1F1F1F] transition-colors duration-200">
                                                    ...
                                                    <td className="bg-[#1A1A1A] px-6 py-5 space-x-2 text-white flex flex-row border border-l-0 border-[#2A2A2A] rounded-tr-lg rounded-br-lg">
                                                      <button
                                                        disabled
                                                        className="px-5 py-2.5 bg-[#C07AF6] rounded-full text-sm text-white cursor-not-allowed hover:bg-[#a46be0] transition-colors"
                                                      >
                                                        Update
                                                      </button>
                                                      <button
                                                        ...
                                                        className="px-5 py-2.5 bg-[#FF5757] rounded-full text-sm text-white hover:bg-[#ff4444] transition-colors"
                                                      >
                                                        Delete
                                                      </button>
                                                    </td>
