    ...
    <>
      ...
      <div className="relative flex items-center justify-center">
        ...
        <img
          src={footer1}
          alt=""
          className="absolute lg:w-[250px] md:w-[250px] sm:w-[150px] w-[150px] left-0 -z-10"
        />
        <img
          src={footer2}
          alt=""
        ...
        <div className=" lg:mt-40 md:mt-40 mt-20 sm:mt-20 flex justify-between  flex-col">
              ...
              <h4
                ...
                className={`text-center lg:w-[150px] md:w-[100px] hover:bg-gradient-to-r from-[#D9D9D924] to-[#14131324] text-white hover:border-[#4B4A4A] hover:border ${
                  isActiveRoute("/")
                    ...
                    : "transparent"
                }  lg:px-7 md:px-7 sm:px-5 px-5 py-3 rounded-xl`}
              >
                Home
              </h4>
              <h4
          ...
          <div className="flex items-center justify-between w-full px-4 mb-4 sm:flex-col flex-col md:flex-row lg:flex-row ">
            ...
            <div className=" space-x-4 items-center lg:flex md:flex sm:hidden hidden  ">
              <a
            ...
            <div className=" space-x-4 items-center lg:hidden md:hidden sm:flex flex  ">
              <a
                href="https://github.com/trigg3rX"
                className="hover:text-gray-300"
                target="blank"
