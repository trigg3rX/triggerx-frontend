  ...
  return (
    <div className=" ">
      ...
      <div className="max-w-[1600px] mx-auto ">
        ...
        <div className="">
          <h2 className="text-lg sm:text-xl text-white mb-3 sm:mb-4">BalanceMaintainer Template</h2>
          <p className="text-sm sm:text-base text-[#A2A2A2] mb-4">
          ...
          <div className="space-y-2">
            ...
            <ul className="list-disc list-inside text-sm sm:text-base text-[#A2A2A2] space-y-2 ml-2">
            ...
            <p className="text-sm sm:text-base text-[#A2A2A2] mt-4 italic">
        ...
        <div className="rounded-lg">
          <div className="text-[#A2A2A2]">
            {isPageLoading ? (
              ...
              <div className="flex flex-col items-center justify-center h-[150px] sm:h-[200px] text-[#A2A2A2]">
              ...
              <>
                <h2 className="text-lg sm:text-xl text-white my-4 sm:my-6">Contract Information</h2>
        ...
        {isPageLoading ? null : isDeployed && (
          <div className="bg-white/5 border border-white/10 p-4 sm:p-5 rounded-lg my-4 sm:my-6">
            <h2 className="text-lg sm:text-xl text-white mb-3">Add Addresses</h2>
        ...
        {isPageLoading ? null : isDeployed && addresses.length > 0 && (
          <div className="p-2 sm:p-4 rounded-lg mb-4 sm:mb-6 ">
            <h2 className="text-base sm:text-lg md:text-xl text-white mb-2 sm:mb-3">Configured Addresses</h2>
              ...
              <div className="border border-white/10 rounded-lg overflow-hidden min-w-[600px]">
                <table className="w-full border-collapse">
                  <thead className="bg-white/5">
                    <tr>
                      <th className="px-2 sm:px-4 md:px-6 py-2 sm:py-3 md:py-5 text-left text-white text-xs sm:text-sm md:text-base">Address</th>
                      <th className="px-2 sm:px-4 md:px-6 py-2 sm:py-3 md:py-5 text-left text-white  text-xs sm:text-sm md:text-base">Current Balance</th>
                      <th className="px-2 sm:px-4 md:px-6 py-2 sm:py-3 md:py-5 text-left text-white  text-xs sm:text-sm md:text-base">Min Balance (ETH)</th>
                    </tr>
                  </thead>
                  <tbody>
                    {addresses.map((item) => (
