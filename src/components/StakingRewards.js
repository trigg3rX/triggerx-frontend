            ...
            <div className="flex-1 space-y-4">
              <div className="flex items-center gap-4">
                <input
                  ...
                  className={`bg-white/5 border border-white/10 rounded-lg px-4 py-4 rounded-lg w-full ${(!isDeployed) && ' cursor-not-allowed'}`}
                  step="0.1"
                  min="0"
                  disabled={!isDeployed || isStaking}
                />
                <button
                  onClick={handleStake}
                  disabled={!isDeployed || isStaking || !stakeAmount}
                  className={`bg-[#FFFFFF] text-black  px-6 py-4 rounded-lg transition-colors whitespace-nowrap ${(!isDeployed || isStaking || !stakeAmount) ? 'opacity-50 cursor-not-allowed' : ''}`}
                >
              ...
              <div className="flex items-center gap-4">
                <input
                  ...
                  step="0.1"
                  min="0"
                  disabled={!isDeployed || isUnstaking}
                />
                <button
                  onClick={handleUnstake}
                  disabled={!isDeployed || isUnstaking || !unstakeAmount}
                  className={`bg-[#FFFFFF] text-black px-6 py-4 rounded-lg transition-colors whitespace-nowrap ${(!isDeployed || isUnstaking || !unstakeAmount) ? 'opacity-50 cursor-not-allowed' : ''}`}
                >
              ...
              <table className="w-full min-w-full border-collapse">
                <thead className="bg-white/5">
                  <tr>
                    ...
                    <th className="px-2 sm:px-4 md:px-6 py-5 text-left text-white w-1/5">Rewards</th>
